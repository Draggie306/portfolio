...
const charlist_things_done: string[] = "What I've done".split('');
const charlist_whoaim: string[] = "About me".split('');
...
async function cyclePortraitPhotos() {
    const element = document.getElementById("portrait-photo-rotator") as HTMLImageElement;
